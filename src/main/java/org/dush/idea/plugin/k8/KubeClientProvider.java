...
public class KubeClientProvider
{
    ...
    {
        clientCache.computeIfAbsent( confFilePath, k -> initWithDefaultConfig( confFilePath ) );
    ...
    {
        clientCache.computeIfAbsent( DEFAULT, k -> initWithDefaultConfig() );
